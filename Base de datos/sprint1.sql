...
-- Dump completed on 2023-08-07 12:44:13
CREATE DATABASE  IF NOT EXISTS `enchante_booking` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `enchante_booking`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: enchante_booking
-- ------------------------------------------------------
-- Server version	8.0.34
...
-- Dump completed on 2023-08-07 12:44:13
CREATE DATABASE  IF NOT EXISTS `enchante_user` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `enchante_user`;
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: enchante_user
-- ------------------------------------------------------
-- Server version	8.0.34
