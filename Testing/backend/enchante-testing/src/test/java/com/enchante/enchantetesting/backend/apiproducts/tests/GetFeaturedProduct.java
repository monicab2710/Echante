...
public class GetFeaturedProduct {

    static ExtentSparkReporter spark = new ExtentSparkReporter("src/test/java/com/enchante/enchantetesting/backend/apiproducts/reports/getFeaturedProduct.html");
    ...
    String productsURL = "http://localhost:8081/api/v1/products/featured";
