            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-primary/[20%] sm:p-[60px]">
                ...
                <form>
                  ...
                  <div className="mb-6">
                    <button className="flex w-full items-center justify-center rounded-md bg-primary py-4 px-9 text-base font-medium text-yellow transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp">
                      Iniciar sesión
                    </button>
                  </div>
                </form>
