      ...
      >
        <div className="bg-primary/10 py-2 text-center">
          <div className="container" >
            <div className="flex justify-center items-center flex-row space-y-6">
              <div className="flex items-row space-y-6">
                <Link href="/" className="mb-1 inline-block">
                  <Image
                    src="images/logo/logo-2.svg"
                    alt="logo"
                    className="dark:hidden mr-10 mt-4"
                    width={170}
                    height={20}
                  />
                  <Image
                    src="images/logo/logo-2.svg"
                    alt="logo"
                    className="hidden dark:block mr-10 mt-4"
                    width={170}
                    height={20}
                  />
                </Link>
...
<div>
              ...
              <p className=" py-3 px-7 text-base font-bold text-black  dark:text-yellow  md:block" >
                Información de Contacto <br />
                Calle Bella, Buenos Aires, <br />
                Distrito Capital. <br />
                Telefono: +54 525 123 523
              </p>

              <p className=" py-3 px-7 text-base font-bold text-black  dark:text-yellow   md:block">
                Horarios de Apertura <br />
                Miercoles a Domingo <br />
                19:00 - 00:30 Horas
              </p>
          ...
          <div className="flex justify-center items-center flex-row space-x" >
            <a
              href="/"
              aria-label="social-link-fb"
              className="mr-6 text-body-color hover:text-yellow"
            >
              <svg
                width="9"
                height="18"
          ...
          <div >
            <p className="text-center text-base text-body-color dark:text-white ">
              © 2023 - Todos los derechos reservados. {"G2"}
            </p>
          </div>
        </div>
      </footer>
